...
export const ChatView = ({ contactId, messages, isTyping, onBack, batteryLevel }: ChatViewProps) => {
  ...
  }, [contactMessages.length, isTyping]);
  ...
  return (
    <div className="h-screen bg-[#ECE5DD] flex flex-col">
      ...
      <div className="bg-gray-100 px-3 py-2 flex items-center gap-2 border-t border-gray-300">
        ...
        <button className="bg-[#25D366] text-white p-3 rounded-full hover:bg-[#20BA5A] transition-colors">
          <Mic size={20} />
        </button>
      </div>
    </div>
